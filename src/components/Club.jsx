...
const Club = () => {
  return (
    <div className="club">
      ...
      <p>EDITOI TEKSTI KUNTOO<b>Hunks Basketball Club ry</b> organizes recreational basketball activities
      ...
      was established to carry forward our mission.
      <br/><br/>
      The flagship teams of Hunks Basketball Club are Currentus and Shooters,
      ...
      remain active participants in our community events.
      <br/><br/>
